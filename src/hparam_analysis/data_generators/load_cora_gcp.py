...
class PlanetoidGcp(InMemoryDataset):
    r"""Modified torch_geometric.datasets.Planetoid for GCP.
    ...
    """
    def __init__(self, url: str, root: str, name: str, split: str = "public",
    ...
    def download(self):
        for name in self.raw_file_names:
            # beam.io.filesystems.FileSystems.copy([f'{self.url}/{name}'], [self.raw_dir])
            gcs_path = f'{self.url}/{self.name.lower()}/{name}'
